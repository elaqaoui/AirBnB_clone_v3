...
class TestAmenityDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_testing_amenity(self):
    ...
    def test_amenity_modules_docstring(self):
    ...
    def test_amenity_classing_docst(self):
    ...
    def test_amenity_functions_docstrings(self):
