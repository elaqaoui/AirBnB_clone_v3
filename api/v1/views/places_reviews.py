...
@swag_from('documentation/reviews/get_all_reviews.yml', methods=['GET'])
...
@swag_from('documentation/reviews/get__all_review.yml', methods=['GET'])
def get__all_review(review_id):
    """
...
def delete_all_review(review_id):
    """
